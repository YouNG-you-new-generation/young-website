      ...
      <section className="py-16" style={{ backgroundColor: siteContent.colors.lightMode.white }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl font-light mb-8" style={{ color: siteContent.colors.lightMode.primary }}>
                Mesaj Gönderin
              </h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium mb-2" style={{ color: siteContent.colors.lightMode.darkGray }}>
                    Ad Soyad
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium mb-2" style={{ color: siteContent.colors.lightMode.darkGray }}>
                    E-posta
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium mb-2" style={{ color: siteContent.colors.lightMode.darkGray }}>
                    Konu
                  </label>
                  <select
                    id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium mb-2" style={{ color: siteContent.colors.lightMode.darkGray }}>
                    Mesaj
                  </label>
                  <textarea
                    id="message"
                ...
                <button
                  ...
                  style={{ backgroundColor: siteContent.colors.lightMode.primary }}
                >
                  Mesaj Gönder
                </button>
              </form>
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: siteContent.colors.lightMode.primary }}>
                    <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium mb-2" style={{ color: siteContent.colors.lightMode.darkGray }}>
                      E-posta
                    </h3>
                    <p className="text-base" style={{ color: siteContent.colors.lightMode.darkGray }}>
              ...
              {/* Social Media */}
              <div className="mt-12">
                <h3 className="text-xl font-medium mb-6" style={{ color: siteContent.colors.lightMode.primary }}>
                  Sosyal Medya
                </h3>
                <div className="flex space-x-4">
                  {[
                    ...
                    <div key={index} className="text-center">
                      ...
                      <span className="text-xs" style={{ color: siteContent.colors.lightMode.darkGray }}>
                        {social.label}
                      </span>
                    </div>
                  ))}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="w-full h-64 rounded-3xl overflow-hidden" style={{ 
            ...
            <div className="w-full h-full flex items-center justify-center">
              <svg className="w-24 h-24" viewBox="0 0 24 24" fill="none" style={{ color: siteContent.colors.lightMode.primary }}>
